                        ...
                        <div class="container">
                            <div class="card">
                                <div class="container">
                                    ...
                                    ?>
                                    <a href="deployment_download_expired_loa_report.php?project_title=<?php echo $project_title ?>&expired_date=<?php echo $from ?>" class="btn btn-dark mb-4"><i class="bi bi-cloud-download"></i> Export</a>
