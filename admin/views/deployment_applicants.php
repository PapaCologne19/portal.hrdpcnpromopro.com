                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                            <div class="contain">
                                                                ...
                                                                <div class="columns">
                                                                    <a href="deployment_download_loa.php?id=<?php echo $rows['id'] ?>" name="download_deploy" class="btn btn-dark btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Download LOA"><i class="bi bi-cloud-download"></i></a>
                                                                </div>
                                                                ...
                                                                <div class="columns">
                                                                    ...
                                                                    ?>
                                                                        <input type="hidden" value="<?php echo $deployment_row['id'] ?>" class="backOutID">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="container">
                                                                                <?php 
                                                                                    ...
                                                                                    $date_now = date('Y-m-d');
                                                                                ?>
                                                                                <form action="deployment_action.php" method="post" class="row" enctype="multipart/form-data">
