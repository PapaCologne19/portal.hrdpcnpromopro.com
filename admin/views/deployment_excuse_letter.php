...
if (isset($_POST['printemp'])) {
    ...
    header("location: deployment_printemp.php");
}
                        ...
                        <div class="container">
                            <div class="card">
                                <div class="container">
                                    ...
                                    <hr>
                                    <form action="deployment_create_excuse_letter.php" method="POST"><br>
                                        ...
                                        <div class="form-group">
                                            <label class="form-label">Reason of excuse</label>
                                            <textarea name="reason_x" id="reason_x" class="form-control" cols="30" rows="10" required></textarea>
                                        </div>
                                        <div class="modal-footer">
                                            <input type="submit" name="xletter1" value="Generate" class="btn btn-info">
                                    </form>
                                </div>
                            </div>
                        </div>
