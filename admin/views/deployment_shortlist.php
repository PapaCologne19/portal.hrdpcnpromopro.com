                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <form action="" method="GET">
                                            ...
                                            <a href="deployment_applicants.php?shortlist_title=<?php echo $row['shortlistname'] ?>" name="view-shortlists" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View Details">
                                                <i class="bi bi-search"></i> 
                                            </a>
                                            <span class="notification badge" style="position: relative; right: 1.5rem;">
                                                <?php 
