                                    ...
                                    <div class="container">
                                        <div class="card">
                                            ...
                                            <div class="tab-content pt-2">
                                                ...
                                                <div class="tab-pane profile-requirements" id="profile-requirements">
                                                    <div class="container table-responsive">
                                                        <hr>
                                                            <div class="title justify-content-center align-items-center mx-auto text-center">
                                                                <h4 class="fs-4">
                                                        ...
                                                        <table class="table" id="example">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                        <tr>
                                                                            <td>
                                                                                <img src="../assets/img/icons/unicons/folder.png" width="5%" alt="">
                                                                                <?php
                                                                                if ($get_resume_row['folder_name'] === "Requirements") {
                                                                                ?>
                                                                                    <a href="ewb_files.php?id=<?php echo $id; ?>&folder_id=<?php echo $get_resume_row['id'] ?>&folder_name=<?php echo $get_resume_row['folder_name'] ?>"><?php echo $get_resume_row['folder_name']; ?></a>
                                                                                <?php } else { ?>
                                                                                    <a href="ewb_files.php?id=<?php echo $id; ?>&folder_id=<?php echo $get_resume_row['id'] ?>&folder_name=<?php echo $get_resume_row['folder_name']; ?>"><?php echo $get_resume_row['folder_name']; ?></a>
                                                                                <?php } ?>
                                                                            </td>
