						...
						<div class="container">
							<div class="card">
								<div class="container">
									...
									<form action="mrf_action.php" method="post" class="form-group row" id="form_request_loa">
										...
										<table class="table table-sm" id="example">
											...
											<tbody>
												<?php
												$id = $_GET['id'];
												$query = "SELECT employees.*, project.*, shortlist.*, shortlist.id AS shortlist_id, DATE_FORMAT(dapplied, '%M %d, %Y') AS dapplied  
