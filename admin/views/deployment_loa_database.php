                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="contain">
                                                            <div class="columns">
                                                                <a href="deployment_download_loa.php?id=<?php echo $fetched['id'] ?>&deployment_id=<?php echo $row['id'] ?>" class="btn btn-dark btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Download LOA"><i class="bi bi-cloud-download"></i></a>
                                                            </div>
                                                            <div class="columns">
                                                            ...
                                                            <div class="columns">
                                                                ...
                                                                <?php if(empty($row['id_remarks'])) { ?>
                                                                    ...
                                                                    <a href="deployment_print_idcard.php?id=<?php echo $row['id'] ?>" name="name" download="<?php echo $row['type'] . "-" . $name ?>" class="btn btn-info btn-sm" data-id="<?php echo $row['emp_id'] ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Download ID"><i class="bi bi-file-earmark-arrow-down"></i></a>
                                                                <?php }?>
                                                            </div>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="deployment_action.php" method="post" class="form-group row" id="myForm">
                                                    ...
                                                    <div class="modal fade" id="uploadLOAPDFModal-<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="deployment_action.php" method="post" class="form-group row" id="myForm" enctype="multipart/form-data">
                                                                        <input type="hidden" name="id" id="id" value="<?php echo $row['id'] ?>">
                                                                        <div class="col-md-12">
