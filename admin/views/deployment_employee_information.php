                                                                ...
                                                                ?>
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                ?>
                                                                                    <a href="deployment_files.php?id=<?php echo $id; ?>&folder_id=<?php echo $get_resume_row['id'] ?>&folder_name=<?php echo $get_resume_row['folder_name'] ?>&name=<?php echo $name ?>"><?php echo $get_resume_row['folder_name']; ?></a>
                                                                                <?php } else { ?>
                                                                                    <a href="deployment_files.php?id=<?php echo $id; ?>&folder_id=<?php echo $get_resume_row['id'] ?>&folder_name=<?php echo $get_resume_row['folder_name']; ?>&name=<?php echo $name ?>"><?php echo $get_resume_row['folder_name']; ?></a>
                                                                                <?php } ?>
                                                                            </td>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="container">
                                                                            <form action="deployment_action.php" method="POST" class="form-group row">
                                                                                <div class="col-md-12">
