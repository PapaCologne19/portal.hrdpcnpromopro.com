                        ...
                        <div class="container">
                            <div class="card">
                                <div class="container">
                                    ...
                                    <hr>
                                    <form action="mrf_action.php" method="post" class="row">
                                        <center>
    ...
    $(document).ready(function() {
        ...
        $('#division').change(function() {
            ...
            if (selectedDivision) {
                ...
                $.ajax({
                    url: 'mrf_get_employee_data.php', // Replace with your server-side script
                    method: 'POST',
                    data: {
    ...
    $(document).ready(function() {
        ...
        $('#division').change(function() {
            ...
            if (selectedDivisionClient) {
                // Make an AJAX request to fetch employee data for the selected division
                $.ajax({
                    url: 'mrf_get_client_company.php', // Replace with your server-side script
                    method: 'POST',
                    data: {
