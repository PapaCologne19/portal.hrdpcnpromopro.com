                                                        ...
                                                        <td class="text-center">
                                                            <div class="contain">
                                                                ...
                                                                <div class="columns">
                                                                    ...
                                                                    ?>
                                                                            <button type="button" class="btn btn-secondary btn-sm" onclick="location.href = 'request_loa.php?id=<?php echo $selects_row['id']; ?>'" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Request LOA">
